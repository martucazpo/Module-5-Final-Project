...
router.post('/form', (req, res) => {
    ...
    User.findOne({ email: email }, async (err, data) => {
        if (err) {
            ...
            res.render('layouts/site/initial-landing.ejs', { errors, regAction,  showRegistration, showLogin });
        } else if (! data) {
            let regAction = "/auth/register/form";
            ...
            if (password1 !== password2){
                ...
                res.render('layouts/site/initial-landing.ejs', { regAction, errors, showRegistration, showLogin });
